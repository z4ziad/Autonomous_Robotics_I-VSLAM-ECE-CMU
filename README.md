...
`/visual_slam/tracking/vo_path`. Here is an example screenshot ![](https://github.com/z4ziad/Auto_Robo_1_VSLAM/blob/main/Screenshot_chrome_1.png) of my foxglove visualization.  
